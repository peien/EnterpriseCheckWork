...
//        _defaults = [KHHDefaults sharedDefaults];
       // _dataCtr = [KHHData sharedData];
        //添加右导航按钮
        UIButton * rightButton = [KHHViewManagerUtils addDefaultRightBarItemByName:@"完成" target:self isLeft:NO];
        [rightButton addTarget:self action:@selector(rightBarButtonClick:)
